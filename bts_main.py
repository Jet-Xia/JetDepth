...
parser.add_argument('--encoder',                   type=str,  default='mobilenetv3_bts')
# Dataset
parser.add_argument('--dataset',                   type=str,   help='dataset to train on, kitti or nyu', default='kitti')
parser.add_argument('--data_path',                 type=str,   help='path to the data', default='train/images')
parser.add_argument('--gt_path',                   type=str,   help='path to the groundtruth data', default='train/labels')
parser.add_argument('--filenames_file',            type=str,   help='path to the filenames text file', default='train_files.txt')
...
parser.add_argument('--use_right',                             help='if set, will randomly use right images when train on KITTI', default='True')
...
parser.add_argument('--data_path_eval',            type=str,   help='path to the data for online evaluation',default='data/test/images')
parser.add_argument('--gt_path_eval',              type=str,   help='path to the groundtruth data for online evaluation', default='data/test/labels')
parser.add_argument('--filenames_file_eval',       type=str,   help='path to the filenames text file for online evaluation', default='test_files.txt')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    var_sum = [var.cpu().detach().sum() for var in model.parameters() if var.requires_grad]
    var_cnt = len(var_sum)
