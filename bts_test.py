...
parser.add_argument('--model_name', type=str, help='model name', default='bts_eigen_v2_pytorch_test')
parser.add_argument('--encoder', type=str, help='type of encoder, vgg or desenet121_bts or densenet161_bts',
                    default='mobilenetv3_bts')
parser.add_argument('--data_path', type=str, help='path to the data',default='data/test/images')
parser.add_argument('--filenames_file', type=str, help='path to the filenames text file', default='test_files.txt')
...
parser.add_argument('--checkpoint_path', type=str, help='path to a specific checkpoint to load', default='models/bts_eigen_v2_pytorch_test/model-128500-best_silog_10.62231')
...
def test(params):
    ...
    for s in tqdm(range(num_test_samples)):
        ...
        cv2.imwrite(filename_cmap_png, image, [cv2.IMWRITE_PNG_COMPRESSION, 0])
        if args.save_lpg:
