...
parser.add_argument('--pred_path',           type=str,   help='path to the prediction results in png', default='result_bts_eigen_v2_pytorch_test/raw')
parser.add_argument('--gt_path',             type=str,   help='root path to the groundtruth data', default='data/test/labels')
parser.add_argument('--dataset',             type=str,   help='dataset to test on, nyu or kitti', default='kitti')
parser.add_argument('--eigen_crop',                      help='if set, crops according to Eigen NIPS14', action='store_true')
parser.add_argument('--garg_crop',                       help='if set, crops according to Garg  ECCV16', action='store_true', default=True)
